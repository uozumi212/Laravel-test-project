<x-guest-layout>
    ...
    <x-alert type="success" :message="session('success_message')" class="my-4 text-white bg-green-400 border-green-300" />
    ...
    @if (session('success_message'))
        <x-alert type="success" message="{{ session('success_message') }}" />
    @endif --}}
</x-guest-layout>
